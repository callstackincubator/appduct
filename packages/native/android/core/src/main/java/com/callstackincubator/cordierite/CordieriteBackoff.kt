...
internal const val CORDIERITE_BACKOFF_BASE_MS = 500L
internal const val CORDIERITE_BACKOFF_CAP_MS = 30_000L
 ...
 */
internal fun computeCordieriteFullJitterBackoffMs(
    attempt: Int,
    baseMs: Long = CORDIERITE_BACKOFF_BASE_MS,
    capMs: Long = CORDIERITE_BACKOFF_CAP_MS,
