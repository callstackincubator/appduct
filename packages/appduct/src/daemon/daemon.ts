 ...
 * call rather than at module load so `APPDUCT_DAEMON_VERSION_OVERRIDE` (issue #30's test seam)
...
const buildStatusResult = async (
  ...
  // handler runs at most once per `appduct daemon status`, and a stat per day file is cheaper
