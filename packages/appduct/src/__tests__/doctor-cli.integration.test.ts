/**
 * CLI-wiring coverage for `appduct doctor`: exercises the real `create-cli.ts` ->
...
describe("appduct doctor: CLI wiring", () => {
  test("exit 0, ok:true JSON when Appduct is present and no assertion was requested", async () => {
