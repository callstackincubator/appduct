 ...
 * duplicated as a hand-written string literal in `AppductConnectionManagerTests.swift` and
 * `AppductSpkiPinTest.kt`. Swift and Kotlin assert the same fixture against their own SPKI-pin
