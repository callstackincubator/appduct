...
export class AppductCliError extends Error {
  readonly type: CliErrorType;
  readonly details?: unknown;

  constructor(type: CliErrorType, message: string, details?: unknown) {
    super(message);
    this.name = "AppductCliError";
    this.type = type;
    this.details = details;
  }
}

export const usageError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("usage_error", message, details);
};

export const validationError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("validation_error", message, details);
};

export const connectionError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("connection_error", message, details);
};

export const sessionError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("session_error", message, details);
};

export const toolError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("tool_error", message, details);
};

export const permissionError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("permission_error", message, details);
};

export const internalError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("internal_error", message, details);
};

export const inspectionError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("inspection_error", message, details);
};

export const assertionError = (message: string, details?: unknown): AppductCliError => {
  return new AppductCliError("assertion_error", message, details);
};

export const isAppductCliError = (value: unknown): value is AppductCliError => {
  return value instanceof AppductCliError;
};
...
export const toCliError = (error: unknown): CliError => {
  ...
  if (isDaemonUnreachableError(error)) {
    return {
      type: "connection_error",
      message: error instanceof Error ? error.message : "The Appduct daemon is unreachable.",
    };
  }
