...
/// same names, descriptions, and schemas -- so `cordierite tools` reports an equivalent surface
...
enum PlaygroundTools {
  /// Called once from `CordieritePlaygroundApp.init()`. `try!` is deliberate: every descriptor
